...
{
    public class WindElementScroll : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            return !modPlayer.HasElement("Ветер");
        }
        ...
        public override bool? UseItem(Player player)
        {
            ...
            if (modPlayer.AddElement("Ветер"))
            {
                Main.NewText("🍃 Ты открыл стихию Ветра! Теперь ты можешь использовать технику Воздушный клинок", Color.LightGreen);
                return true;
            }
